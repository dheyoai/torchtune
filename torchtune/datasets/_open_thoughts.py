...
from torchtune.data._messages import AlpacaToMessages, OpenThoughtsToMessages
...
def open_thoughts_dataset(
    tokenizer: ModelTokenizer,
    *,
    source: str = "open-thoughts/OpenThoughts-114k",
    ...
    **load_dataset_kwargs: dict[str, Any],
    ...
    load_dataset_kwargs.update({"name": "metadata"})
...
# open_thoughts_dataset_v1 = partial(open_thoughts_dataset)
